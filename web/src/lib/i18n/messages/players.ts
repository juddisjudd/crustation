export const players = {
	...
	act: {
		...
		giveHint: 'Pick one, or type any id the server will take.',
		gave: 'Gave {item} to {name}',
		item: 'Item',
		itemSearch: 'Search by name or id',
		itemAsTyped: 'as typed',
		itemNone: 'Nothing matches that.',
		itemLoading: 'Reading the item list…',
		itemTypeInstead: 'The list could not be read. Type an id and the server will judge it.',
		itemSome: 'Showing {shown} of {total}. Keep typing to narrow it.',
		itemFromServer: '{total} items, as this server listed them, add-ons included.',
